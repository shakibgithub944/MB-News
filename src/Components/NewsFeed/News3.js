...
const News3 = () => {
    return (
        <div className='mb-8 border rounded-lg p-5'>
            <h1 className='text-3xl font-bold'>Microstrategy Buys More Bitcoin — Company's Crypto Holdings Grow to 132,500 BTC.</h1>
            <p className=''>Sunday, 3 Jan 2023</p>
            <img src="https://cdn.coingape.com/wp-content/uploads/2021/01/27103501/MicroStrategy-Bitcoin-Corporate-Virtual-Summit.jpg" className='w-full' alt="" />
            <p className='my-5'>
                ...
                Microstrategy Acquires More Bictoin
