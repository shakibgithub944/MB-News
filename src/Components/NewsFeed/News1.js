...
const News1 = () => {
    return (
        <div className='mb-8 border rounded-lg p-5'>
            <h1 className='text-3xl font-bold'>PayPal enables transfer of digital currencies to external wallets.</h1>
            <p className=''>Sunday, 3 Jan 2023</p>
            <img src="https://s201.q4cdn.com/346340278/files/design/who-we-are.jpg" className='w-full' alt="" />
            <p className='my-5'>
