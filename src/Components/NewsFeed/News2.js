...
const News2 = () => {
    return (
        <div className='mb-8 border rounded-lg p-5'>
            <h1 className='text-3xl font-bold'>Italian Parliament Approves 26% Crypto-Gains Tax in 2023 Budget.</h1>
            <p className=''>Sunday, 3 Jan 2023</p>
            <img src="https://i0.wp.com/italiancultureoggi.com/wp-content/uploads/2020/07/Government.jpg?fit=1000%2C541&ssl=1" className='w-full' alt="" />
            <p className='my-5'>
